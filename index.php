...
<html>
<head>
  <title>SAN TECH Ltd | QR Code Generator</title>
...
<meta name="author" content="Senior developer Niyongana Anathole ">
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" method="post" enctype="multipart/form-data">
    <div class="container">
      ...
      <input type="text" name="qrId" value="<?php if(isset($_POST['create'])){ echo $_POST['qrId']; } ?>">
